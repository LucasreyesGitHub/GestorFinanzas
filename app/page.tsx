        ...
        <section className="glass-card p-8">
          <div className="grid gap-6 lg:grid-cols-[1.4fr_0.8fr]">
            <div>
              ...
              <h1 className="mt-3 text-4xl font-semibold text-ink-100 break-words">Hola, {session.user?.email}</h1>
            ...
            <div className="rounded-3xl bg-ink-900/80 p-6 text-sm text-ink-200">
              ...
              <p className="mt-4 text-lg font-semibold text-ink-100 break-words">{session.user?.email}</p>
